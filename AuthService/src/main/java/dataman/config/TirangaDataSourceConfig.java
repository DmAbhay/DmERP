...
public class TirangaDataSourceConfig {
    ...
    @Autowired
    private ExternalConfigAuthService externalConfig;  // Ensure this class is defined and injected correctly here we companyDb name becouse company tabel is here
